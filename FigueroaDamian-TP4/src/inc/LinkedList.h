...
/** \brief  Testea getNode que es privada.
 *
 * \param this LinkedList* Puntero a la lista
...
/** \brief filter llama a pFunc y le pasa cada uno de los elementos de la lista y si pFunc devuelve 1(TRUE) a ese elemento lo agrego a lanueva lista
 *
...
/** \brief Le pasa todos los elementos a pFunc y lo que devuelve pFunc lo acumula en un acumulador.
 *
 * \param LinkedList* this, puntero a la lista
 * \param pFunc (*pFunc), puntero a la funcion.
 * \return devuelve 0 si no hubo elementos acumulador, o mayor que cero si funciono.
 *
 */
